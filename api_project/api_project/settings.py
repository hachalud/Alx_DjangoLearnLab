...
SECRET_KEY = 'django-insecure-!+37(7%b&powsrb7e$g#5@7bz17-6rzh%ac+w57_08y&r&(0ng'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'rest_framework.authentication.SessionAuthentication',  # Optional: login via admin
    ],
