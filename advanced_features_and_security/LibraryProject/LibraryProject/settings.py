...
SECRET_KEY = 'django-insecure-@4=g=9jnnqw=on%hi^e=p1u#2bzhph!$ws@7ww-sd(+p+==^a!'
...
# This ensures users always connect securely
...
# sent by a reverse proxy (e.g., Nginx, Apache, Heroku)
# so Django knows the request is HTTPS.
